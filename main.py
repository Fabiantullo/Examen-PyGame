...
def main():
    ...
    diccionario_ronda = crear_diccionario_ronda(DIFICUTYS, palabras, TRYS)
    boton_modos = crear_lista_botones_dificultad(ventana, fuentes["fuente_palabras"], "Black","salmon", DIFICUTYS)
    ...
    while bandera_juego:
        ...
        manejar_juego(diccionario_partida, ventana, diccionario_ronda, fuentes, entrada, palabras, DIFICUTYS, carteles, lista_boton_pistas, boton_modos)
        reloj.tick(20)
        pg.display.update()
    pg.quit()
